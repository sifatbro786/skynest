            ...
            <Section>
                ...
                <Measure className="mt-12 space-y-12">
                    <Block title="এই ওয়েবসাইট কী">
                        <p>
                            এটি {site.name}-এর একটি ক্যাটালগ ওয়েবসাইট। এখানে কোনো কার্ট,
                            অনলাইন পেমেন্ট বা অর্ডার ব্যবস্থা নেই। ওয়েবসাইটে কোনো প্রাণী দেখে
                            পছন্দ হলে আপনি যোগাযোগ করেন, তারপর সরাসরি কথা বলে বা ফার্মে এসে
                            লেনদেন হয়।
                        </p>
                    </Block>
                    ...
                    <Block title="দাম">
                        <p>
                            ...
                            পরিস্থিতি অনুযায়ী চূড়ান্ত দাম আলোচনায় ঠিক হয়। কোনো প্রাণীর
                            ক্ষেত্রে &ldquo;দাম জানতে যোগাযোগ করুন&rdquo; লেখা থাকলে বুঝতে হবে
                            দামটি নির্দিষ্ট নয়।
                        </p>
                        <p>
                            দাম আগাম ঘোষণা ছাড়াই পরিবর্তিত হতে পারে। ওয়েবসাইটে দেখানো দাম
                            কোনো বিক্রয় প্রস্তাব বা চুক্তি নয়।
                        </p>
                    </Block>
                    ...
                    <Block title="প্রাপ্যতা">
                        <p>
                            ...
                            একটি প্রাণী ইতিমধ্যে বুকড বা বিক্রি হয়ে থাকতে পারে — বিশেষ করে
                            ফোনে কথা বলার আগেই। রওনা দেওয়ার আগে একবার ফোন করে নিশ্চিত হয়ে
                            নেওয়াই নিরাপদ।
                        </p>
                    </Block>
                    ...
                    <Block title="স্বাস্থ্য ও ভ্যাকসিনেশনের তথ্য">
                        <p>
                            প্রতিটি প্রাণীর পাতায় ভ্যাকসিনেশনের যে অবস্থা লেখা থাকে, সেটি
                            আমাদের নিজস্ব রেকর্ড অনুযায়ী <strong>যা করা হয়েছে তার বিবরণ</strong>
                            — কোনো পশুচিকিৎসকের সনদ বা ভবিষ্যৎ স্বাস্থ্যের নিশ্চয়তা নয়।
                        </p>
                        <p>
                            আমরা যতটুকু জানি ততটুকুই লিখি, এবং যা জানা নেই তা
                            &ldquo;প্রযোজ্য নয়&rdquo; বা &ldquo;বাকি আছে&rdquo; হিসেবেই দেখাই।
                            নেওয়ার আগে নিজে দেখে নেওয়া এবং প্রয়োজনে নিজের পশুচিকিৎসক দিয়ে
                            পরীক্ষা করিয়ে নেওয়ার পরামর্শ দিই।
                        </p>
                    </Block>
                    ...
                    <Block title="ফার্ম ভিজিট">
                        <p>
                            ...
                            নিশ্চিত হয়ে যাওয়া নয় — আমরা ফোন বা WhatsApp-এ নিশ্চিত করার পরই
                            সময়টি চূড়ান্ত।
                        </p>
                        <p>
                            ফার্মে জীবিত প্রাণী থাকে। সেখানে অবস্থানকালে নিজের ও সঙ্গে আসা
                            শিশুদের নিরাপত্তার দায়িত্ব দর্শনার্থীর। কর্মীদের নির্দেশনা মেনে
                            চলার অনুরোধ রইল।
                        </p>
                    </Block>
                    ...
                    <Block title="লেনদেন">
                        <p>
                            ...
                            দেখে, পছন্দ হলে তবেই লেনদেন। এই ওয়েবসাইটের মাধ্যমে কোনো টাকা
                            লেনদেন হয় না — কেউ এই সাইটের নাম করে অগ্রিম চাইলে আগে আমাদের
                            নম্বরে যাচাই করে নিন।
                        </p>
                    </Block>
                ...
                <Measure as="p" className="mt-6 text-xs leading-relaxed text-ink-mute">
                    এই শর্তাবলি সরল ভাষায় লেখা খসড়া। এটি আইনি পরামর্শ নয় — প্রকাশের আগে
                    একজন আইনজীবীকে দিয়ে দেখিয়ে নেওয়া ভালো।
                </Measure>
            </Section>
        </SiteShell>
    );
