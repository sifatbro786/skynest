        ...
        <main className="shell flex flex-1 flex-col justify-center py-24 md:py-32">
            <div className="grid gap-14 lg:grid-cols-12 lg:items-end lg:gap-10">
                <div className="lg:col-span-7">
                    ...
                    <p className="text-lede mt-7 max-w-prose text-ink-soft">{site.description}</p>
                ...
                <aside className="lg:col-span-4 lg:col-start-9">
                    ...
                    <dl className="mt-6 space-y-5">
                        <div>
                            <dt className="text-micro uppercase text-ink-mute">সরাসরি যোগাযোগ</dt>
                            <dd className="tnum mt-1 font-display text-title">{site.phone}</dd>
                        </div>
                        <div>
